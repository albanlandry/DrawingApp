...
#define kServiceAppUrlScheme    @"nvloginaction"

#define kConsumerKey            @"4ZkcqYi6NUt9Vd77264u"
#define kConsumerSecret         @"smMXoQNxqN"
#define kServiceAppName         @"nvloginaction"
